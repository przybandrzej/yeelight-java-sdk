package pl.przybysz.yeelight_sdk.socket;

import org.pmw.tinylog.Logger;
import pl.przybysz.yeelight_sdk.exception.YeelightSocketException;
...
public class YeelightSocketHolder {
     ...
     * @throws YeelightSocketException when socket error occurs
     */
    public void send(String data) throws YeelightSocketException {
        try {
            Logger.debug("Sending data [{}] to {}:{}", data, this.ip, this.port);
    ...
    public String readLine() throws YeelightSocketException {
        try {
            String data = this.socketReader.readLine();
            Logger.debug("Received data [{}] from {}:{}", data, this.ip, this.port);
            return data;
        } catch (Exception e) {
            throw new YeelightSocketException(e);
        }
